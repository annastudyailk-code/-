...
| Safety/claims | Placement report, rendered ad/landing, approved claim/disclosure state from [offer-claims-registry](../../shared/aaron-marketing-skills/protocol/offer-claims-registry/SKILL.md) (the paid claims SSOT) |
...
Read `../../../references/auditor-runbook.md`, `scoring-semantics.md`, `roas-benchmark.md`, and the ROAS catalog entry. Standalone installs use bundled immutable `references/auditor-runtime.md`; never fetch mutable `main`. Before deterministic calls, follow [`runtime-invocation.md`](../../shared/aaron-marketing-skills/references/runtime-invocation.md), resolve `AARON_SKILLS_ROOT="${CLAUDE_PLUGIN_ROOT:-$(git rev-parse --show-toplevel 2>/dev/null || true)}"`, and require the scorer, validator, and typed catalogs. If unavailable, return `score_state: NOT_SCORED` / `score_confidence: not_scored` with no gate verdict or persistent artifact.
...
- [ROAS benchmark](../../shared/aaron-marketing-skills/references/roas-benchmark.md)
- [Measurement protocol](../../shared/aaron-marketing-skills/references/measurement-protocol.md)
- [Auditor runbook](../../shared/aaron-marketing-skills/references/auditor-runbook.md)
- [Scoring semantics](../../shared/aaron-marketing-skills/references/scoring-semantics.md)

## Next Best Skill

- **Tracking:** [conversion-signal-qa](../conversion-signal-qa/SKILL.md)
- **Claims/disclosures:** [offer-claims-registry](../../shared/aaron-marketing-skills/protocol/offer-claims-registry/SKILL.md) — the approved claim/disclosure state behind `ROAS-O1`
