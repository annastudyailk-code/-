...
For implementation, see the [tools registry](../../shared/coreyhaines-marketingskills/tools/REGISTRY.md).

| Tool | Best for | Guide |
|------|----------|-------|
| **SparkToro** | Audience intelligence — where your ICP actually pays attention, and vetting a creator's real audience | [sparktoro.md](../../shared/coreyhaines-marketingskills/tools/integrations/sparktoro.md) |
