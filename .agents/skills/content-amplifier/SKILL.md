...
- **Primary next skill**: *paid* → [performance-analyzer](../performance-analyzer/SKILL.md) once campaigns are live; *repurpose* → [landing-optimizer](../../shared/aaron-marketing-skills/influencer/report/landing-optimizer/SKILL.md) to place the repurposed social proof where it converts.

### Handoff Summary

> Emit the standard shape from [skill-contract.md §Handoff Summary Format](../../shared/aaron-marketing-skills/references/skill-contract.md). State which mode ran. Label every metric Measured / User-provided / Estimated — never present a CPM, ROAS, view count, or rights date you were not given as Measured; if it is missing, ask for the export or mark it Estimated with the basis.
...
See [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) for the verified free/keyless recipe per category. None are required; absent a connector, the user supplies the numbers.
...
- Per-platform format & placement specs: [tiktok](../../shared/aaron-marketing-skills/references/platforms/tiktok.md) · [youtube](../../shared/aaron-marketing-skills/references/platforms/youtube.md) · [linkedin](../../shared/aaron-marketing-skills/references/platforms/linkedin.md) · [x](../../shared/aaron-marketing-skills/references/platforms/x.md) · [reddit](../../shared/aaron-marketing-skills/references/platforms/reddit.md) · [grokipedia](../../shared/aaron-marketing-skills/references/platforms/grokipedia.md).
- [star-benchmark.md](../../shared/aaron-marketing-skills/references/star-benchmark.md) — the STAR framework; the Trust vetoes (`STAR-T1` FTC disclosure, `STAR-T2` claim integrity) that creator-content-auditor enforces before this skill runs.
- [skill-contract.md](../../shared/aaron-marketing-skills/references/skill-contract.md) — shared contract and Handoff Summary format.
- [state-model.md](../../shared/aaron-marketing-skills/references/state-model.md) — HOT/WARM/COLD memory tiers and save conventions.
- [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) — free/keyless data recipe per connector category.
- Sibling skills: [creator-content-auditor](../creator-content-auditor/SKILL.md), [contract-helper](../../shared/aaron-marketing-skills/influencer/activate/contract-helper/SKILL.md), [landing-optimizer](../../shared/aaron-marketing-skills/influencer/report/landing-optimizer/SKILL.md), [budget-optimizer](../../shared/aaron-marketing-skills/influencer/target/budget-optimizer/SKILL.md), [performance-analyzer](../performance-analyzer/SKILL.md).
...
- *repurpose mode* → [landing-optimizer](../../shared/aaron-marketing-skills/influencer/report/landing-optimizer/SKILL.md) — drop the repurposed testimonials, hero videos, and quote cards onto the pages that convert.
...
- [contract-helper](../../shared/aaron-marketing-skills/influencer/activate/contract-helper/SKILL.md) — secure or expand usage rights before reuse (repurpose).
- [budget-optimizer](../../shared/aaron-marketing-skills/influencer/target/budget-optimizer/SKILL.md) — reallocate paid budget across the recommended tiers (paid).
