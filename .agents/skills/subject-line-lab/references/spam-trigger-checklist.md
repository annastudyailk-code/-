...
- No authentication check (SPF/DKIM/DMARC) — that is SEND-S, [deliverability-qa](../../deliverability-qa/SKILL.md).
- No body-copy spam scan — this covers subject + preheader only; the body is [email-creative-builder](../../../shared/aaron-marketing-skills/email/engage/email-creative-builder/SKILL.md), gated by [email-quality-auditor](../../email-quality-auditor/SKILL.md).
- No claim substantiation — a flagged false-scarcity or superlative gets `[needs source]`; [offer-claims-registry](../../../shared/aaron-marketing-skills/protocol/offer-claims-registry/SKILL.md) resolves it.
