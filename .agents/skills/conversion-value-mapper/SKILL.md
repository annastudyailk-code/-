...
- [ROAS Benchmark](../../shared/aaron-marketing-skills/references/roas-benchmark.md) — where `R1`/`R2` (measurement-signal integrity, of which value integrity is part) sit in the Return dimension; this skill is their value-side prerequisite
- [ad-account-auditor](../ad-account-auditor/SKILL.md) — scores `R1`/`R2` and the full RQS once the value model and signal are fixed
- [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) — `~~web analytics`, `~~ecommerce` own-data export recipes
