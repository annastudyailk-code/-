...
- **Primary next skill**: [brief-generator](../../shared/aaron-marketing-skills/influencer/target/brief-generator/SKILL.md)
...
See [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) for the free/keyless data recipe per category. Without any connector, ask the user for the missing inputs and proceed.
...
- [skill-contract.md](../../shared/aaron-marketing-skills/references/skill-contract.md) — shared contract and handoff schema.
- [state-model.md](../../shared/aaron-marketing-skills/references/state-model.md) — memory tiers and save-path conventions.
- [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) — free/keyless data recipes per connector category.
- [audience-mapper](../audience-mapper/SKILL.md) — define the target audience this plan serves.
- [brief-generator](../../shared/aaron-marketing-skills/influencer/target/brief-generator/SKILL.md) — turn the plan into per-influencer briefs.
- [budget-optimizer](../../shared/aaron-marketing-skills/influencer/target/budget-optimizer/SKILL.md) — refine the budget allocation.
- [influencer-discovery](../influencer-discovery/SKILL.md) — find influencers matching the criteria.

## Next Best Skill

- **Primary**: [brief-generator](../../shared/aaron-marketing-skills/influencer/target/brief-generator/SKILL.md) — convert the approved plan into concrete influencer briefs.
- **Alternate**: [budget-optimizer](../../shared/aaron-marketing-skills/influencer/target/budget-optimizer/SKILL.md) — pressure-test and optimize the budget split before locking the plan.
