...
**Scope guard**: this skill wires personalization onto existing copy for existing segments only. It does **not** define WHO the segments are ([list-segment-builder](../list-segment-builder/SKILL.md)), does **not** write the subject/body/CTA ([email-creative-builder](../../shared/aaron-marketing-skills/email/engage/email-creative-builder/SKILL.md)), and does **not** score, roll up the EQS, or run the S1/S2/N1/D1 vetoes ([email-quality-auditor](../email-quality-auditor/SKILL.md) owns those).
...
- **Reads**: the email creative to personalize (from [email-creative-builder](../../shared/aaron-marketing-skills/email/engage/email-creative-builder/SKILL.md)); the segment map and the available export columns + fill-rates (from [list-segment-builder](../list-segment-builder/SKILL.md)); the program mode (promo / cold / newsletter); and, when a personalized line makes a promotional claim, approved wording from `memory/claims/claims-ledger.md` (the [offer-claims-registry](../../shared/aaron-marketing-skills/protocol/offer-claims-registry/SKILL.md)).
...
- **Primary next skill**: [email-render-builder](../../shared/aaron-marketing-skills/email/engage/email-render-builder/SKILL.md) to assemble the personalized template into a rendered, cross-client email; or [email-quality-auditor](../email-quality-auditor/SKILL.md) to score the finished unit and run the vetoes.
...
- [email-creative-builder](../../shared/aaron-marketing-skills/email/engage/email-creative-builder/SKILL.md) — upstream; produces the base copy this skill personalizes
- [list-segment-builder](../list-segment-builder/SKILL.md) — upstream; defines the named segments the conditional blocks key on
- [email-render-builder](../../shared/aaron-marketing-skills/email/engage/email-render-builder/SKILL.md) — assembles the personalized template into a rendered, cross-client email (next skill)
- [email-quality-auditor](../email-quality-auditor/SKILL.md) — the SEND gate; scores EQS and runs S1/S2/N1/D1 (next skill)
- [offer-claims-registry](../../shared/aaron-marketing-skills/protocol/offer-claims-registry/SKILL.md) — `memory/claims/claims-ledger.md` SSOT for approved claim wording in personalized lines
...
- **Primary**: [email-render-builder](../../shared/aaron-marketing-skills/email/engage/email-render-builder/SKILL.md) — assemble the personalized template into a rendered, cross-client-safe email; or [email-quality-auditor](../email-quality-auditor/SKILL.md) to score the finished unit and run the vetoes.
- **If a personalized line makes an unregistered promotional claim**: [offer-claims-registry](../../shared/aaron-marketing-skills/protocol/offer-claims-registry/SKILL.md) — register lawful wording before that variation ships (registry is the sole writer of `memory/claims/`).
