...
| Restricted / prohibited content (O2 risk) | Flag to [ad-account-auditor](../../ad-account-auditor/SKILL.md); do not ship |
...
- [roas-benchmark.md](../../../shared/aaron-marketing-skills/references/roas-benchmark.md) — the O (Offer) dimension this feed data feeds
- [ad-account-auditor](../../ad-account-auditor/SKILL.md) — runs the O1 (claim) / O2 (policy) vetoes
- [humanizer-slop.md](../../../shared/aaron-marketing-skills/references/humanizer-slop.md) — de-slop pass over rewritten titles/descriptions
