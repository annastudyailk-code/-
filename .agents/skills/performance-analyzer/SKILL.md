...
- **Primary next skill**: [roi-calculator](../../shared/aaron-marketing-skills/influencer/report/roi-calculator/SKILL.md) — turn measured performance into dollar-level return.
...
**Measured YouTube post-performance (free key)**: when campaign content lives on YouTube, `python3 "${CLAUDE_PLUGIN_ROOT}/scripts/connectors/youtube.py" videos @creator --limit 20` pulls the actual per-video views/likes/comments for the campaign window — **Measured** platform metrics without waiting for the creator's screenshot export. Keep both labels honest: API numbers are Measured, creator-supplied numbers are User-provided, and the two can legitimately disagree (display rounding, timing). Free `YOUTUBE_API_KEY`. See [scripts/connectors/README.md](../../shared/aaron-marketing-skills/scripts/connectors/README.md).
...
No placeholder is required to run. See [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) for the verified free/keyless data recipe per category.
...
Before naming any creator/format/platform a real winner, clear the significance bar in [measurement-protocol.md](../../shared/aaron-marketing-skills/references/measurement-protocol.md) — otherwise mark it Keep-testing. When a structured score is needed, apply per-dimension STAR analysis (Suitability/Trust/Appeal/Return dimension reads) from [star-benchmark.md](../../shared/aaron-marketing-skills/references/star-benchmark.md), and hand the measured inputs to [roi-calculator](../../shared/aaron-marketing-skills/influencer/report/roi-calculator/SKILL.md) for the measured Return (R) evidence — this skill contributes the inputs but does not compute the SQS (the creator-content-auditor gate does).
...
- [skill-contract.md](../../shared/aaron-marketing-skills/references/skill-contract.md) — shared contract and handoff format.
- [state-model.md](../../shared/aaron-marketing-skills/references/state-model.md) — memory tiers and save-path conventions.
- [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) — verified free/keyless data recipes per connector category.
- [measurement-protocol.md](../../shared/aaron-marketing-skills/references/measurement-protocol.md) — preregistered readback windows, outcome unit, alpha, practical-effect boundary, multiplicity/sequential policy, guardrails, and decision owner. Report statistical and practical flags separately; use `experiment.py` for deterministic `Calculated` evidence, and never substitute a universal p-value/lift rule or attribute a business action to the helper.
- The STAR benchmark at [references/star-benchmark.md](../../shared/aaron-marketing-skills/references/star-benchmark.md) — scoring architecture when a structured score is needed.
- Sibling skills: [roi-calculator](../../shared/aaron-marketing-skills/influencer/report/roi-calculator/SKILL.md), [report-generator](../../shared/aaron-marketing-skills/influencer/report/report-generator/SKILL.md), [fit-scorer](../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md), [campaign-planner](../campaign-planner/SKILL.md).

## Next Best Skill

**Primary**: [roi-calculator](../../shared/aaron-marketing-skills/influencer/report/roi-calculator/SKILL.md) — convert measured performance into dollar-level ROI, cost-per-result, and payback math.

**Alternates** (same Report family):

- [report-generator](../../shared/aaron-marketing-skills/influencer/report/report-generator/SKILL.md) — package the analysis into a formal stakeholder report.
- [fit-scorer](../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md) — feed proven performers back into creator scoring for the next round.
