...
> defensible score is computed downstream by [fit-scorer](../../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md).
...
1. Review top recommendations with [fit-scorer](../../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md)
2. Develop outreach strategy with [outreach-manager](../../../shared/aaron-marketing-skills/influencer/activate/outreach-manager/SKILL.md)
3. Create campaign briefs with [brief-generator](../../../shared/aaron-marketing-skills/influencer/target/brief-generator/SKILL.md)
