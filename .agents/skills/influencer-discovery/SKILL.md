...
- **Reads**: brand/product, niche or category, target platforms, follower range, engagement floor, location/language, audience demographics, exclusions; prior `entity-registry` brand profile and any `audience-mapper` output if present in memory; existing roster records under `memory/creators/` (dedupe the candidate pool against creators already rostered by [creator-registry](../../shared/aaron-marketing-skills/protocol/creator-registry/SKILL.md)).
...
- **Primary next skill**: [fit-scorer](../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md) — score and rank the discovered candidates with weighted criteria.
...
- [CONNECTORS.md](../../shared/aaron-marketing-skills/CONNECTORS.md) — free/keyless data recipes and opt-in MCP layer.
- STAR benchmark at [references/star-benchmark.md](../../shared/aaron-marketing-skills/references/star-benchmark.md) — scoring framework that fit-scorer applies downstream.
- Siblings in the scout phase: [fit-scorer](../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md), [audience-mapper](../audience-mapper/SKILL.md), [trend-spotter](../../shared/aaron-marketing-skills/influencer/scout/trend-spotter/SKILL.md).

## Next Best Skill

**Primary**: [fit-scorer](../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md) — score and rank the discovered candidates with weighted criteria before outreach.

**Alternates (same influencer family)**:
- [competitor-tracker](../../shared/aaron-marketing-skills/influencer/target/competitor-tracker/SKILL.md) — when discovery surfaced competitor-saturated creators and you want to map the competitive field first.
...
- [fit-scorer](../../shared/aaron-marketing-skills/influencer/scout/fit-scorer/SKILL.md) - Score and rank discovered influencers
- [competitor-tracker](../../shared/aaron-marketing-skills/influencer/target/competitor-tracker/SKILL.md) - Find competitor influencers
- [outreach-manager](../../shared/aaron-marketing-skills/influencer/activate/outreach-manager/SKILL.md) - Contact discovered influencers
