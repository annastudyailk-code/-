...
This compliance gate is the STAR **Trust** review ([Trust dimension](../../../shared/aaron-marketing-skills/references/star-benchmark.md)). Two Trust items are veto-level — a failure forces the overall decision to **Reject** (never "revise"), and you must cite the veto ID:
