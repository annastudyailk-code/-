...
Read `../../../references/auditor-runbook.md`, `scoring-semantics.md`, `star-benchmark.md`, and the STAR catalog entry. Standalone installs use the bundled immutable `references/auditor-runtime.md`; never fetch mutable `main`. Before deterministic calls, follow [`runtime-invocation.md`](../../shared/aaron-marketing-skills/references/runtime-invocation.md), resolve `AARON_SKILLS_ROOT="${CLAUDE_PLUGIN_ROOT:-$(git rev-parse --show-toplevel 2>/dev/null || true)}"`, and require the scorer, validator, and typed catalogs. If unavailable, return `score_state: NOT_SCORED` / `score_confidence: not_scored` with no gate verdict or persistent artifact.
...
- [STAR benchmark](../../shared/aaron-marketing-skills/references/star-benchmark.md)
...
- [Humanizer controls](../../shared/aaron-marketing-skills/references/humanizer-slop.md)

## Next Best Skill

- **Brief mismatch:** [brief-generator](../../shared/aaron-marketing-skills/influencer/target/brief-generator/SKILL.md)
- **Claim fix:** [offer-claims-registry](../../shared/aaron-marketing-skills/protocol/offer-claims-registry/SKILL.md)
- **Rights/terms:** [contract-helper](../../shared/aaron-marketing-skills/influencer/activate/contract-helper/SKILL.md)
